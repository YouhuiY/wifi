...
EdcaTxopN::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::EdcaTxopN")
    ...
    .AddTraceSource ("CwTrace",
                     ...
                     "ns3::TracedValue::Uint32Callback")
    /*.AddTraceSource ("DC_collision", 
                     " the type of traffic",
                     MakeTraceSourceAccessor(&EdcaTxopN::DC_collisionTrace),
                     "ns3::TraceValue::Uint32Callback")
    .AddTraceSource ("DT_collision",   
                     " the type of traffic",
                     MakeTraceSourceAccessor(&EdcaTxopN::DT_collisionTrace),
                     "ns3::TraceValue::Uint32Callback")*/
...
{
  NS_LOG_FUNCTION (this);
  //std::cout<< "queue"<< m_queue<<std::endl;
  return m_queue;
}
...
void
EdcaTxopN::GetAccessCategory (void)
{
